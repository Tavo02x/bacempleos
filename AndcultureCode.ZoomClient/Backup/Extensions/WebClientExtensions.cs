  ...
  public static class WebClientExtensions
  {
      ...
      Method method)
    {
      ...
      Dictionary<string, object> dictionary = new Dictionary<string, object>()
      {
        ...
        {
          "exp",
          (object) new DateTimeOffset(DateTime.UtcNow.AddMinutes(1.0)).ToUnixTimeSeconds()
        }
      };
      webClient.set_Authenticator((IAuthenticator) new JwtAuthenticator(JWT.Encode((object) dictionary, (object) Encoding.UTF8.GetBytes(options.ZoomApiSecret), (JwsAlgorithm) 1, (IDictionary<string, object>) null, (JwtSettings) null)));
      restRequest.set_JsonSerializer((ISerializer) new NewtonsoftJsonSerializer());
      return restRequest;
    }
  }
}
